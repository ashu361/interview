var Home = React.createClass({
	...
	render: function () {
		...
		if (this.state.existingApplication) {
			table = React.createElement(Applications, { applications: this.state.applications, applicationsWithInterview: this.state.applicationsWithInterview, anchors: this.state.anchors });
			navButtons = React.createElement(
				'span',
				null,
				React.createElement(
					'button',
					{ className: 'fs-submit', onClick: this.fetchPrevApplications },
					'Prev'
				),
				React.createElement(
					'button',
					{ className: 'fs-submit', onClick: this.fetchNextApplications },
					'Next'
				)
			);
		}
		if (this.state.newApplication) {
			table = React.createElement(Anchors, { anchors: this.state.anchors });
		}
		return React.createElement(
			'div',
			{ className: 'fs-form-wrap', id: 'fs-form-wrap' },
			React.createElement(
				'div',
				{ className: 'fs-title center-align outer-border' },
				React.createElement(
					'button',
					{ className: 'fs-submit', type: 'submit', onClick: this.onClickNewApplication },
					'New Application '
				),
				...
				React.createElement(
					'button',
					{ className: 'fs-submit', type: 'submit', onClick: this.fetchPipelineData },
				...
				React.createElement(
					'span',
					null,
					React.createElement('input', { type: 'text', placeholder: 'Search application', className: 'input',
