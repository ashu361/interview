...
;(function (window) {
  ...
  */
	FForm.prototype._init = function () {
		...
		var inputTextFirst = firstField.querySelector('input[type="text"]');
		if (inputTextFirst) inputTextFirst.focus();

		var inputNumberFirst = firstField.querySelector('input[type="number"]');
		if (inputNumberFirst) inputNumberFirst.focus();

		var inputEmailFirst = firstField.querySelector('input[type="email"]');
		if (inputEmailFirst) inputEmailFirst.focus();
		// create/add controls
		this._addControls();
	...
	FForm.prototype._checkFieldChange = function () {
		this.fieldsList = this.formEl.querySelector('ol.fs-fields');
		this.fields = [].slice.call(this.fieldsList.children);
		this.fieldsCount = this.fields.length;
  ...
  */
	...
	FForm.prototype._updateControls = function () {
		// main controls wrapper
		//this.ctrls = createElement( 'div', { cName : 'fs-controls', appendTo : this.el } );
  ...
  this.ctrlNavDots = [].slice.call( this.ctrlNav.children );*/
		...
		if (this.options.ctrlNavPosition) {
			...
			this.ctrlFldStatusTotal = this.ctrlFldStatus.querySelector('.fs-number-total');
			this.ctrlFldStatusTotal.innerHTML = this.fieldsCount;
		}
  ...
  */
	FForm.prototype._nextField = function (backto) {
		if (backto == undefined) this._checkFieldChange();
		...
		//console.log(this.current + ' currentFld');
		//console.log(this.isLastStep + ' Last Step');
		...
		if (!this.isLastStep) {
			...
			var inputText = nextField.querySelector('input[type="text"]');
			if (inputText) inputText.focus();

			var inputNumber = nextField.querySelector('input[type="number"]');
			if (inputNumber) inputNumber.focus();

			var inputEmail = nextField.querySelector('input[type="email"]');
